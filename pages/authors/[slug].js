    ...
    <Layout
      ...
      <div className={styles.heroArea}>
        <div className={styles.patternBlock}>
          {/* <div
              style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg width='52' height='26' viewBox='0 0 52 26' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='${baseBgColor?.hex?.replace(
                  "#",
                  "%23"
