  ...
  return (
    <Layout title="Privacy policy" description="Privacy policy">
      <div className={commonStyles.page}>
        ...
        <p>
          This website does not collect or store your personal data via cookies, analytics services
          (e.g. Google Analytics), social media share buttons, nor any other method.
        </p>

        {/* Generated by and hosted at: https://www.privacypolicies.com/live/eba8ee53-e907-461a-8bcc-7f37ba969d91 */}
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sandi
              Plewis.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Sandi Plewis, accessible from{" "}
              <a
                href="https://www.sandiplewis.com/"
                rel="external nofollow noopener noreferrer"
                target="_blank">
                https://www.sandiplewis.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          efforts to ensure that before we collect any personal information from a child, the
          child’s parent receives notice of and consents to our personal information practices.
        </p>
        <p>
          ...
          functionality of the Service to these Users. If We need to rely on consent as a legal
          basis for processing Your information and Your country requires consent from a parent, We
        ...
        <p>
          For further details on the information We might collect, You can refer to the &quot;Types
          of Data Collected&quot; section of this Privacy Policy. We follow our standard Privacy
        ...
        <ul>
          <li>
            <p>By email: sandiplewis@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://www.sandiplewis.com/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank">
                https://www.sandiplewis.com/contact
              </a>
            </p>
          </li>
        </ul> */}
